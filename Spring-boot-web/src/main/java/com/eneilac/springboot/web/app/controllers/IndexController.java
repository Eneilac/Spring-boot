...
public class IndexController {
	...
	public String index(Model model) {
		...
		model.addAttribute("titulo", "Hola Spring Framework"); // lo primero es el nombre del contenedor y lo segundo su
																// valor.
	...
	public String perfil(Model model) {
		...
		model.addAttribute("usuario", usuario); // Pasamos el objeto a la interfaz model para poder tratar esos datos en
												// la vista.
		model.addAttribute("titulo", "Perfil del usuario: ".concat(usuario.getNombre())); // lo primero es el nombre del
	...
	public List<Usuario>pasarUsuarios(){
		...
		List<Usuario> usuarios = Arrays.asList(new Usuario("Eduardo", "Neila", "edu@gmail.com"),  //seria mas simple hacerlo asi con la clase Arrays de java util
